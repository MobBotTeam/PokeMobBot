...
namespace PoGo.PokeMobBot.Logic
{
    ...
    public class GlobalSettings
    {
        ...
        public Dictionary<PokemonId, TransferFilter> PokemonsTransferFilter = new Dictionary<PokemonId, TransferFilter>
        {
            ...
            {PokemonId.Nidoqueen, new TransferFilter(1750, 60, 1)},
            {PokemonId.Nidoking, new TransferFilter(1750, 60, 1)},
            {PokemonId.Clefable, new TransferFilter(1500, 60, 1)},
            {PokemonId.Vileplume, new TransferFilter(1500, 60, 1)},
            ...
            {PokemonId.Farfetchd, new TransferFilter(1000, 80, 1)},
