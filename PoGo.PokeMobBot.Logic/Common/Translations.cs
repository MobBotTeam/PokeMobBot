...
namespace PoGo.PokeMobBot.Logic.Common
{
    ...
    public class Translation : ITranslation
    {
            ...
            <KeyValuePair<TranslationString, string>>
        {
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.InvItemsTier1,
                "[Inventory] Pokeballs: {0}\t || Razz Berries: {1}\t || Potions: {2}\t\t || Incenses: {3}\t\t || Revives: {4}"),
            new KeyValuePair<TranslationString, string>(TranslationString.InvItemsTier2,
                "[Inventory] Greatballs: {0}\t || Bluk Berries: {1}\t || Super Potions: {2}\t || Spicy Incenses: {3}\t || Max Revives: {4}"),
            new KeyValuePair<TranslationString, string>(TranslationString.InvItemsTier3,
                "[Inventory] Ultraballs: {0}\t || Nanab Berries: {1}\t || Hyper Potions: {2}\t || Cool Incenses: {3}\t || Lucky Eggs: {4}"),
            new KeyValuePair<TranslationString, string>(TranslationString.InvItemsTier4,
                "[Inventory] Masterballs: {0}\t || Wepar Berries: {1}\t || Max Potions: {2}\t || Floral Incenses: {3}\t || Lure Module: {4}"),
            new KeyValuePair<TranslationString, string>(TranslationString.InvItemsTier5,
